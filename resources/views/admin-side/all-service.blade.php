...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> View Service List</li>
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <h3 class="box-title"> View Service List</h3>
                            ...
                            <div class="col-md-3" style="text-align: right; padding-top:30px;">
                                ...
                                <div class="form-group no-print">
                                    ...
                                    <a href="{{url('add-service')}}" title="Add New Service" class="hvr-grow" data-toggle="tooltip"><img src="assets/dist/img/add.png"></a>
